...
type EvictCallback[K comparable, V comparable] func(key K, value V)
...
func New[K comparable, V comparable](size int, onEvict EvictCallback[K, V]) (*LRU[K, V], error) {
	if size <= 0 {
